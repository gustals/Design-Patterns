...
public class DeliverTruckSmallCargo implements Transport {

    private final String DELIVERY_TYPE = "SMALL-TRUCK";
    private final double MIN_KG_DELIVER;
    private final double MAX_KG_DELIVER;

    private final double CARGO_KG;

    public DeliverTruckSmallCargo(double cargo_kg) {
        CARGO_KG = cargo_kg;
        MIN_KG_DELIVER = CargoWeightSize.EARTH_SMALL_MIN_KG_DELIVER.value();
        MAX_KG_DELIVER = CargoWeightSize.EARTH_SMALL_MAX_KG_DELIVER.value();
    }
